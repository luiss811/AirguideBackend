...
export const updateEventoSchema = z.object({
  nombre: z.string().min(1, 'El nombre debe tener al menos 1 caracter').optional(),
  descripcion: z.string().optional(),
  fecha_inicio: z.string().datetime('Fecha inválida').optional(),
  fecha_fin: z.string().datetime('Fecha inválida').optional(),
