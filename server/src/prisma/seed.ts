...
async function main() {
  ...
  console.log('Usuarios creados:', { admin, alumno1, alumno2 });
  ...
  console.log('5 edificios creados');
  ...
  // Crear detalles de ruta 1 (Biblioteca -> Ingeniería)
  ...
  // Crear detalles de ruta 2 (Ingeniería -> Auditorio)
  await prisma.rutaDetalle.createMany({
    data: [
      {
  ...
  // Crear detalles de ruta 3 (Biblioteca -> Auditorio)
  await prisma.rutaDetalle.createMany({
    data: [
      {
  ...
  console.log('Detalles de rutas creados');
  ...
  console.log('\nResumen:');
  console.log('- Usuarios: 3 (1 admin, 2 alumnos)');
  console.log('- Edificios: 5');
  console.log('- Salones: 9');
  console.log('- Profesores: 3');
  console.log('- Cubículos: 3');
  console.log('- Eventos: 4');
  console.log('- Rutas: 3');
  console.log('- Logs de acceso: 3');
}
